...
async function main() {
  ...
  const starterPlan = await prisma.plan.create({
    data: {
      ...
      features: [
        ...
        "Follow-up reminders",
        "Private CRM review hub",
        "Approve by phone or email",
  ...
  const pipelinePlan = await prisma.plan.create({
    data: {
      name: "AI Sales Team",
      description: "Three AI employees working your pipeline",
      setupFee: 1000,
      monthlyPrice: 997,
      features: [
  ...
  const growthPlan = await prisma.plan.create({
    data: {
      ...
      description: "A complete AI sales department",
      setupFee: 1500,
      monthlyPrice: 1997,
      features: [
  ...
  const demoCompany = await prisma.company.create({
    data: {
      ...
      setupStatus: "LIVE",
      stripePlanName: "AI Sales Assistant",
      members: {
  ...
  const leadsSeed = [
    ...
    },
    {
      ...
      fitSummary: "High-volume e-commerce agency. Full AI Revenue OS fit.",
